...
export class Decimal {
    ...
    ceil() {
        if (this.mag < 0) {
            if (this.sign === 1)
                return Decimal.dOne; //The ceiling function called on something tiny like 10^10^-100 should return 1, since 10^10^-100 is still greater than 0
            else
                return Decimal.dZero;
        }
        if (this.sign === -1)
    ...
    linear_sroot(degree) {
        ...
        if (this.gt(1)) {
            ...
            while (_loopGoing) {
                ...
                if (Decimal.pow(10, _guess).recip().tetrate(degree, 1, true).gt(this))
                    _upper = _guess;
                else
                    _lower = _guess;
    ...
    static isFinite = function (_isFinite) {
     ...
     * Analytic approximation is not currently supported for bases > 10.
     */
    static tetrate(value, height, payload, linear) {
     ...
     * Identical to tetrate.
     */
    static iteratedexp(value, height, payload, linear) {
        var height = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
        var payload = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : FC_NN(1, 0, 1);
        var linear = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
     ...
     * Analytic approximation is not currently supported for bases > 10.
     */
    static iteratedlog(value, base, times, linear) {
     ...
     * For non-whole pentation heights, the linear approximation of pentation is always used, as there is no defined analytic approximation of pentation.
     */
    static pentate(value, height, payload, linear) {
        var height = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
        var payload = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : FC_NN(1, 0, 1);
        var linear = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
